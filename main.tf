...
resource "local_file" "ansible_inventory" {
  ...
  content  = <<EOT
[cert_emp_deploy]
${yandex_compute_instance.vm1.network_interface.0.nat_ip_address} ansible_user=ubuntu ansible_ssh_extra_args='-o StrictHostKeyChecking=no' ansible_ssh_private_key_file=/var/lib/jenkins/.ssh/id_ed25519
[cert_emp_prod]
${yandex_compute_instance.vm2.network_interface.0.nat_ip_address} ansible_user=ubuntu ansible_ssh_extra_args='-o StrictHostKeyChecking=no' ansible_ssh_private_key_file=/var/lib/jenkins/.ssh/id_ed25519
EOT
